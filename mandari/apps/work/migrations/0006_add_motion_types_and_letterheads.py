    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "content_margin_left",
                    models.PositiveIntegerField(default=25, verbose_name="Abstand links (mm)"),
                ),
                (
                    "content_margin_right",
                    models.PositiveIntegerField(default=20, verbose_name="Abstand rechts (mm)"),
                ),
                (
                    "content_margin_bottom",
                    models.PositiveIntegerField(default=30, verbose_name="Abstand unten (mm)"),
                ),
                (
                    "font_family",
                    models.CharField(default="Arial", max_length=100, verbose_name="Schriftart"),
                ),
                (
                    "font_size",
                    models.PositiveIntegerField(default=11, verbose_name="Schriftgröße (pt)"),
                ),
                (
                    "is_default",
                    models.BooleanField(default=False, verbose_name="Standard-Briefkopf"),
                ),
                ("is_active", models.BooleanField(default=True, verbose_name="Aktiv")),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
