    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "invitation_sent",
                    models.BooleanField(default=False, verbose_name="Einladung versendet"),
                ),
                (
                    "invitation_sent_at",
                ...
                (
                    "protocol_approved",
                    models.BooleanField(default=False, verbose_name="Protokoll genehmigt"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    apps.common.encryption.EncryptedTextField(verbose_name="Beschreibung"),
                ),
                (
                    "decision_encrypted",
                ...
                (
                    "has_decision",
                    models.BooleanField(default=False, verbose_name="Beschluss gefasst"),
                ),
                (
                    "votes_for",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "duration_minutes",
                    models.PositiveIntegerField(default=120, verbose_name="Dauer (Minuten)"),
                ),
                (
                    "default_location",
                    models.CharField(blank=True, max_length=500, verbose_name="Standard-Ort"),
                ),
                (
                    "default_video_link",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "prepared_at",
                    models.DateTimeField(blank=True, null=True, verbose_name="Vorbereitet am"),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "submitted_at",
                    models.DateTimeField(blank=True, null=True, verbose_name="Eingereicht am"),
                ),
                (
                    "author",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "selection_end",
                    models.PositiveIntegerField(blank=True, null=True, verbose_name="Auswahl Ende"),
                ),
                (
                    "selected_text",
                ...
                (
                    "resolved_at",
                    models.DateTimeField(blank=True, null=True, verbose_name="Erledigt am"),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "file",
                    models.FileField(upload_to="motions/documents/%Y/%m/", verbose_name="Datei"),
                ),
                (
                    "filename",
                ...
                (
                    "file_size",
                    models.PositiveIntegerField(default=0, verbose_name="Dateigröße (Bytes)"),
                ),
                (
                    "text_content",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_shared_party",
                    models.BooleanField(default=False, verbose_name="Partei-weit teilen"),
                ),
                (
                    "is_default",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "resolved_at",
                    models.DateTimeField(blank=True, null=True, verbose_name="Gelöst am"),
                ),
                (
                    "closed_at",
                    models.DateTimeField(blank=True, null=True, verbose_name="Geschlossen am"),
                ),
                (
                    "assigned_to",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "file",
                    models.FileField(upload_to="support/attachments/%Y/%m/", verbose_name="Datei"),
                ),
                (
                    "filename",
                    models.CharField(max_length=255, verbose_name="Dateiname"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "reminder_date",
                    models.DateTimeField(blank=True, null=True, verbose_name="Erinnerung"),
                ),
                (
                    "tags",
                    models.JSONField(blank=True, default=list, verbose_name="Tags"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "responded_at",
                    models.DateTimeField(blank=True, null=True, verbose_name="Antwort am"),
                ),
                (
                    "checked_in_at",
                    models.DateTimeField(blank=True, null=True, verbose_name="Eingecheckt um"),
                ),
                (
                    "checked_out_at",
                    models.DateTimeField(blank=True, null=True, verbose_name="Ausgecheckt um"),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "new_time",
                    models.TimeField(blank=True, null=True, verbose_name="Neue Uhrzeit"),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                (
                    "schedule",
