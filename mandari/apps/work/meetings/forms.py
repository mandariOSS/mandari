...
class MeetingPreparationForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ["is_prepared"]
        widgets = {
            "is_prepared": forms.CheckboxInput(
                attrs={"class": "w-5 h-5 text-primary-600 border-gray-300 rounded focus:ring-primary-500"}
            )
        }
...
class AgendaItemPositionForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            "position": forms.RadioSelect(attrs={"class": "hidden peer"}),
            "discussion_note": forms.Textarea(
                attrs={
                    "rows": 2,
            ...
            "is_final": forms.CheckboxInput(
                attrs={"class": "w-4 h-4 text-primary-600 border-gray-300 rounded focus:ring-primary-500"}
            ),
        }
...
class AgendaItemNoteForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "is_decision": forms.CheckboxInput(
                attrs={"class": "w-4 h-4 text-primary-600 border-gray-300 rounded focus:ring-primary-500"}
            ),
...
class QuickNoteForm(forms.Form):
    ...
    visibility = forms.ChoiceField(choices=AgendaItemNote.VISIBILITY_CHOICES, initial="organization")
