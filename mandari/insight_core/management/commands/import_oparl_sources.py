...
OPARL_SOURCES = [
    ...
    (
        ...
        "https://hiddenhausen.ratsinfomanagement.net/webservice/oparl/v1.1/system",
    ),
    (
        "Gemeinde Kirchlengern",
        "https://kirchlengern.ratsinfomanagement.net/webservice/oparl/v1.1/system",
    ),
    (
        "Gemeinde Rödinghausen",
        "https://roedinghausen.ratsinfomanagement.net/webservice/oparl/v1.1/system",
    ),
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.NOTICE(f"is_active will be set to: {activate}\n"))
        ...
        for name, url in OPARL_SOURCES:
            try:
                ...
                if was_created:
                    ...
                    skipped += 1
                    self.stdout.write(self.style.HTTP_INFO(f"  - {name} (exists)"))
        ...
        if created > 0 and not activate:
            ...
            self.stdout.write(self.style.NOTICE("Activate them in Django Admin to start syncing."))
