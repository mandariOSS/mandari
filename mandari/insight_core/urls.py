...
insight_patterns = [
    ...
    path(
        "personen/partials/list/",
        views.PersonListPartial.as_view(),
        name="person_list_partial"
    ),
    ...
    path(
        "vorgaenge/<uuid:pk>/zusammenfassung/",
        views.paper_summary,
        name="paper_summary"
    ),
    path(
        "vorgaenge/partials/list/",
        views.PaperListPartial.as_view(),
        name="paper_list_partial"
    ),
    ...
    path(
        "termine/partials/list/",
        views.MeetingListPartial.as_view(),
        name="meeting_list_partial"
    ),
    path(
        "termine/partials/calendar-events/",
